...
class __Mustache_79a446298d6abc916274ed33a83359e8 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</h2>
';
        $buffer .= $indent . '        <h2 class="ms-2 mt-2"> ';
        $value = $this->resolveValue($context->find('questiontitle'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '</h2>
';
        $buffer .= $indent . '        <h3 class="px-2 py-1 ms-2 mt-2">
';
...
';
        ...
        $buffer .= '" class="btn btn-secondary me-1 mb-1" id="id_restart_question_preview" ';
...
';
        ...
        $buffer .= '" class="btn btn-secondary me-1 mb-1" id="id_save_question_preview" ';
...
';
        ...
        $buffer .= '" class="btn btn-secondary me-1 mb-1" ';
...
';
        ...
        $buffer .= '" class="btn btn-secondary me-1 mb-1" id="id_finish_question_preview" ';
        $value = $this->resolveValue($context->find('finishdisabled'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '>
';
        ...
        if (empty($value)) {
            ...
            $buffer .= '" class="btn btn-secondary me-1 mb-1" id="close-previewquestion-page">
';
        }
        $value = $context->find('redirect');
        $buffer .= $this->section0d435b713722c9b2689addee3206c25a($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</form>
';
...
';
    ...
    private function section0d435b713722c9b2689addee3206c25a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '" class="btn btn-secondary me-1 mb-1" role="button">';
                $value = $context->find('str');
                $buffer .= $this->section93ff76985c4533d7046185baf8a48aa3($context, $indent, $value);
                $buffer .= '</a>
';
