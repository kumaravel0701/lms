...
class __Mustache_955464814547ffa28df98309a8af2b0a extends Mustache_Template
{
...
';
        ...
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionA2030dbc209b7b9580fc668dbff85495($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                ';
...
';
    ...
    private function sectionA2030dbc209b7b9580fc668dbff85495(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
