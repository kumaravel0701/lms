...
class __Mustache_857c4b6aa91800536015d3946d2d6d2a extends Mustache_Template
{
...
';
        $value = $context->find('hasblocks');
        $buffer .= $this->section36d3b8cd83b0dc20c1cdf8230abee312($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function section36d3b8cd83b0dc20c1cdf8230abee312(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <div data-region="blocks-column">
';
                $buffer .= $indent . '                    ';
